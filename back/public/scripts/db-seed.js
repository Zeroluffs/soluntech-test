...
async function seed() {
  ...
  await Promise.all([
    ...
    Account.create({
      ...
      lastName: "Green",
      username: "eve",
      password: bcrypt.hashSync("eve", salt),
      profession: "Artist",
      balance: 456.78,
      type: "buyer",
    }),
    Account.create({
      ...
      lastName: "Williams",
      username: "mark",
      password: bcrypt.hashSync("mark", salt),
      profession: "Writer",
      balance: 81.13,
      type: "buyer",
    }),
    ...
    Account.create({
      ...
      lastName: "Smith",
      username: "jane",
      password: bcrypt.hashSync("jane", salt),
    ...
    Account.create({
      ...
      lastName: "Johnson",
      username: "mike",
      password: bcrypt.hashSync("mike", salt),
      profession: "Designer",
      balance: 500.33,
      type: "supplier",
    }),
    Account.create({
      ...
      lastName: "Brown",
      username: "lucy",
      password: bcrypt.hashSync("lucy", salt),
